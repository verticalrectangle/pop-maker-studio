...
LOOKS = {
    ...
    'coquette': [
        ...
        ('shadow', S(lid=((225, 160, 175), 45), crease=((205, 135, 150), 38),
                     outer=((190, 115, 135), 32), inner=((255, 240, 245), 40),
                     shimmer=((255, 246, 250), 26))),
        ('liner', dict(style='soft', alpha=170)),
        ('lashes', dict(strength=0.7, style='doll')),
        ('lashes', dict(strength=0.3, style='wispy', lower=True)),
        ('aegyo', dict(alpha=15)),
    ...
    'peach': [
        ...
        ('shadow', S(lid=((240, 160, 110), 48), crease=((220, 135, 90), 40),
                     outer=((200, 115, 75), 34), inner=((255, 240, 225), 40), shimmer=((255, 245, 235), 25))),
    ...
    'cold_beauty': [
        ...
        ('lashes', dict(strength=0.5, style='wispy')),
    ...
    # ── realistic reference-driven collection (mup/ references) ─────────────
    # All translucent, mid-luma, layered — the engine's luminance-transfer
    # blend adapts pigment to the wearer's skin (no opaque foundation washes).
    'korean_dewy': [   # 01: K-beauty — dewy base, straight soft brow, gradient coral lip
        ('blush', dict(style='cheeks', color=(255, 150, 140), alpha=35)),
        ('aegyo', dict(alpha=16)),
        ('shadow', S(lid=((225, 170, 160), 40), crease=((205, 145, 140), 30),
                     inner=((255, 245, 240), 40), shimmer=((255, 250, 245), 25))),
        ('liner', dict(style='tightline', color=(60, 40, 36), alpha=150)),
        ('lashes', dict(strength=0.5, style='wispy')),
        ('brow', dict(color=(80, 60, 50), alpha=70, width=0.050, density=0.45)),
        ('lip', dict(style='blurred', color=(230, 110, 100), alpha=95)),
        ('highlight', dict(style='glass', color=(255, 250, 248), alpha=55)),
    ],
    'chinese_classic': [   # 03: porcelain base, precise wing, red lip
        ('contour', dict(style='soft', alpha=25, areas=['cheek', 'nose'])),
        ('blush', dict(style='lifted', color=(230, 130, 120), alpha=28)),
        ('shadow', S(lid=((210, 170, 155), 35), crease=((185, 140, 125), 28),
                     inner=((250, 240, 235), 38))),
        ('liner', dict(style='wing', alpha=230)),
        ('lashes', dict(strength=0.8, style='cat')),
        ('brow', dict(color=(60, 45, 40), alpha=100, width=0.060, density=0.6)),
        ('lip', dict(style='satin', color=(190, 30, 45), alpha=140,
                     liner_color=(140, 18, 32))),
        ('highlight', dict(style='satin', color=(255, 248, 245), alpha=40)),
    ],
    'indian_bridal': [   # 07: gold/rust shadow, kohl rim, red lip
        ('contour', dict(style='warm', alpha=40)),
        ('blush', dict(style='cheeks', color=(230, 120, 105), alpha=40)),
        ('shadow', S(lid=((230, 180, 90), 65), crease=((190, 110, 60), 55),
                     outer=((150, 80, 45), 45), inner=((255, 240, 200), 45),
                     shimmer=((255, 230, 160), 40), lower=((60, 40, 40), 55))),
        ('liner', dict(style='wing', alpha=235)),
        ('lashes', dict(strength=1.0, style='stage')),
        ('lashes', dict(strength=0.35, style='wispy', lower=True)),
        ('brow', dict(color=(55, 38, 32), alpha=120, width=0.070, density=0.8)),
        ('lip', dict(style='satin', color=(175, 25, 40), alpha=150,
                     liner_color=(120, 20, 30))),
        ('highlight', dict(style='satin', color=(255, 240, 210), alpha=50)),
    ],
    'bollywood': [   # 08: violet-blue smoke, kohl, bright pink lip
        ('blush', dict(style='cheeks', color=(220, 120, 140), alpha=35)),
        ('shadow', S(lid=((120, 90, 180), 60), crease=((80, 60, 140), 55),
                     outer=((45, 35, 90), 50), inner=((230, 220, 255), 40),
                     shimmer=((210, 200, 255), 35), lower=((90, 70, 150), 40))),
        ('liner', dict(style='wing', alpha=230)),
        ('lashes', dict(strength=1.0, style='stage')),
        ('brow', dict(color=(50, 36, 32), alpha=115, width=0.068, density=0.7)),
        ('lip', dict(style='gloss', color=(215, 85, 130), alpha=110)),
        ('highlight', dict(style='satin', color=(245, 240, 255), alpha=45)),
    ],
    'latina_glam': [   # 11: bronze crease, fluffy brow, nude-brown lined gloss
        ('contour', dict(style='warm', alpha=48)),
        ('blush', dict(style='lifted', color=(225, 140, 115), alpha=42)),
        ('shadow', S(lid=((215, 165, 115), 55), crease=((180, 130, 85), 50),
                     outer=((145, 100, 60), 45), inner=((250, 235, 215), 40),
                     shimmer=((255, 235, 200), 30))),
        ('liner', dict(style='wing', alpha=220)),
        ('lashes', dict(strength=0.95, style='stage')),
        ('lashes', dict(strength=0.3, style='wispy', lower=True)),
        ('brow', dict(color=(65, 45, 38), alpha=110, width=0.068, density=0.7)),
        ('lip', dict(style='lined_gloss', color=(185, 130, 110), alpha=110,
                     liner_color=(130, 85, 70))),
        ('highlight', dict(style='satin', color=(255, 245, 230), alpha=52)),
    ],
    'chola': [   # 12: thin high arch, long wing, dark-lined nude lip
        ('contour', dict(style='soft', alpha=40)),
        ('blush', dict(style='sculpted', color=(210, 130, 115), alpha=30)),
        ('shadow', S(lid=((205, 160, 130), 40), crease=((175, 125, 95), 35),
                     inner=((245, 230, 215), 35))),
        ('liner', dict(style='siren', alpha=225)),
        ('lashes', dict(strength=0.85, style='cat')),
        ('brow', dict(color=(45, 30, 28), alpha=130, width=0.035, density=0.5)),
        ('lip', dict(style='lined_gloss', color=(160, 95, 80), alpha=130,
                     liner_color=(90, 45, 40))),
        ('highlight', dict(style='satin', color=(250, 240, 230), alpha=38)),
    ],
    'pinup': [   # 19: vintage matte, bold wing, red lip
        ('contour', dict(style='soft', alpha=30, areas=['cheek'])),
        ('blush', dict(style='apple', color=(235, 130, 120), alpha=38)),
        ('shadow', S(lid=((235, 220, 205), 30), crease=((200, 170, 150), 28),
                     inner=((250, 245, 240), 35))),
        ('liner', dict(style='wing', alpha=235)),
        ('lashes', dict(strength=0.9, style='doll')),
        ('brow', dict(color=(60, 45, 38), alpha=105, width=0.055, density=0.6)),
        ('lip', dict(style='matte', color=(190, 25, 40), alpha=170,
                     liner_color=(140, 15, 30))),
        ('highlight', dict(style='satin', color=(255, 248, 242), alpha=32)),
    ],
    'arab_kohl': [   # 24/25: kohl-rimmed smoke, angular brow, rose-brown lip
        ('contour', dict(style='warm', alpha=42)),
        ('blush', dict(style='cheeks', color=(215, 130, 115), alpha=32)),
        ('shadow', S(lid=((215, 170, 120), 55), crease=((170, 120, 85), 55),
                     outer=((120, 80, 60), 55), inner=((245, 230, 210), 35),
                     lower=((60, 40, 40), 70))),
        ('liner', dict(style='siren', alpha=235)),
        ('lashes', dict(strength=1.0, style='stage')),
        ('lashes', dict(strength=0.4, style='wispy', lower=True)),
        ('brow', dict(color=(45, 32, 28), alpha=125, width=0.070, density=0.75)),
        ('lip', dict(style='satin', color=(165, 95, 90), alpha=120,
                     liner_color=(120, 65, 62))),
        ('highlight', dict(style='satin', color=(255, 242, 225), alpha=45)),
    ],
    'siren_night': [   # 60: elongated wing, mauve-violet smoke, deep gloss
        ('contour', dict(style='cool', alpha=35)),
        ('blush', dict(style='lifted', color=(200, 120, 140), alpha=28)),
        ('shadow', S(lid=((165, 120, 165), 55), crease=((130, 90, 140), 50),
                     outer=((95, 60, 105), 48), inner=((240, 225, 245), 40),
                     shimmer=((230, 215, 245), 30), lower=((120, 85, 130), 35))),
        ('liner', dict(style='siren', alpha=230)),
        ('lashes', dict(strength=1.0, style='cat')),
        ('brow', dict(color=(55, 40, 45), alpha=105, width=0.060, density=0.65)),
        ('lip', dict(style='gloss', color=(140, 40, 70), alpha=130,
                     liner_color=(95, 25, 50))),
        ('highlight', dict(style='pearl', color=(245, 240, 250), alpha=45)),
    ],
    'fox_eye': [   # 61: lifted bronze outer corner, straight elongated liner
        ('contour', dict(style='warm', alpha=30, areas=['cheek', 'temple'])),
        ('blush', dict(style='lifted', color=(225, 150, 130), alpha=25)),
        ('shadow', S(lid=((210, 165, 125), 40), crease=((180, 135, 95), 38),
                     outer=((150, 105, 70), 45), inner=((250, 240, 225), 35))),
        ('liner', dict(style='siren', alpha=225)),
        ('lashes', dict(strength=0.9, style='cat')),
        ('brow', dict(color=(70, 50, 42), alpha=95, width=0.055, density=0.55)),
        ('lip', dict(style='satin', color=(195, 140, 125), alpha=90)),
        ('highlight', dict(style='satin', color=(255, 245, 235), alpha=42)),
    ],
    'doe_eye': [   # 62: round open eye, bright inner/lower, doll lashes, peach
        ('blush', dict(style='apple', color=(250, 150, 155), alpha=40)),
        ('aegyo', dict(alpha=22)),
        ('shadow', S(lid=((240, 195, 175), 40), crease=((220, 160, 145), 30),
                     inner=((255, 250, 245), 55), lower=((255, 245, 240), 30))),
        ('liner', dict(style='tightline', color=(50, 35, 32), alpha=150)),
        ('lashes', dict(strength=0.95, style='doll')),
        ('lashes', dict(strength=0.45, style='doll', lower=True)),
        ('brow', dict(color=(75, 55, 48), alpha=80, width=0.055, density=0.5)),
        ('lip', dict(style='gloss', color=(240, 140, 140), alpha=85)),
        ('highlight', dict(style='pearl', color=(255, 248, 248), alpha=50)),
    ],
    'y2k_glow': [   # 66: coral-orange wash, gold shimmer lid, juicy gloss
        ('blush', dict(style='sunkissed', color=(255, 140, 95), alpha=40)),
        ('shadow', S(lid=((245, 190, 100), 55), crease=((235, 120, 70), 50),
                     outer=((210, 100, 55), 40), inner=((255, 245, 220), 45),
                     shimmer=((255, 240, 200), 45))),
        ('liner', dict(style='soft', color=(70, 45, 40), alpha=170)),
        ('lashes', dict(strength=0.7, style='wispy')),
        ('brow', dict(color=(85, 55, 40), alpha=85, width=0.058, density=0.55)),
        ('lip', dict(style='gloss', color=(245, 170, 140), alpha=60)),
        ('highlight', dict(style='glass', color=(255, 245, 225), alpha=55)),
    ],
    'nineties_brown': [   # 65: matte taupe monochrome, brown liner + lip
        ('contour', dict(style='soft', alpha=35)),
        ('blush', dict(style='cheeks', color=(200, 130, 110), alpha=28)),
        ('shadow', S(lid=((170, 135, 115), 45), crease=((140, 105, 90), 42),
                     outer=((115, 85, 70), 38), inner=((225, 210, 200), 30))),
        ('liner', dict(style='soft', color=(60, 40, 35), alpha=185)),
        ('lashes', dict(strength=0.6, style='wispy')),
        ('brow', dict(color=(55, 40, 35), alpha=95, width=0.040, density=0.5)),
        ('lip', dict(style='matte', color=(135, 85, 70), alpha=150,
                     liner_color=(95, 60, 50))),
        ('highlight', dict(style='satin', color=(245, 238, 230), alpha=30)),
    ],
    'eighties_pop': [   # 64: blue-purple shadow to brow, draped pink blush, fuchsia
        ('blush', dict(style='draped', color=(245, 120, 150), alpha=50)),
        ('shadow', S(lid=((90, 120, 220), 60), crease=((120, 80, 190), 55),
                     outer=((80, 50, 150), 50), inner=((220, 225, 255), 40),
                     shimmer=((200, 215, 255), 40))),
        ('liner', dict(style='wing', alpha=220)),
        ('lashes', dict(strength=0.9, style='stage')),
        ('brow', dict(color=(65, 50, 45), alpha=100, width=0.065, density=0.6)),
        ('lip', dict(style='gloss', color=(215, 60, 120), alpha=120)),
        ('highlight', dict(style='pearl', color=(240, 240, 255), alpha=48)),
    ],
    'seventies_sun': [   # 63: warm earth eye, 70s lower lashes, peach gloss
        ('blush', dict(style='sunkissed', color=(245, 150, 95), alpha=45)),
        ('shadow', S(lid=((215, 160, 105), 45), crease=((185, 130, 85), 40),
                     outer=((160, 105, 70), 35), inner=((255, 240, 215), 40),
                     lower=((170, 120, 80), 35))),
        ('liner', dict(style='soft', color=(65, 45, 38), alpha=165)),
        ('lashes', dict(strength=0.8, style='doll')),
        ('lashes', dict(strength=0.4, style='wispy', lower=True)),
        ('brow', dict(color=(75, 55, 45), alpha=85, width=0.058, density=0.5)),
        ('lip', dict(style='gloss', color=(240, 150, 120), alpha=95)),
        ('highlight', dict(style='satin', color=(255, 235, 200), alpha=55)),
    ],
    'cut_crease': [   # 57: sharp taupe crease over champagne lid
        ('contour', dict(style='soft', alpha=30)),
        ('blush', dict(style='lifted', color=(225, 145, 125), alpha=30)),
        ('shadow', S(lid=((245, 225, 200), 50), crease=((150, 115, 95), 75),
                     outer=((120, 90, 75), 60), inner=((255, 245, 235), 45),
                     shimmer=((255, 250, 240), 35))),
        ('liner', dict(style='wing', alpha=225)),
        ('lashes', dict(strength=0.9, style='stage')),
        ('brow', dict(color=(60, 45, 38), alpha=105, width=0.060, density=0.6)),
        ('lip', dict(style='lined_gloss', color=(185, 135, 120), alpha=100,
                     liner_color=(140, 95, 85))),
        ('highlight', dict(style='satin', color=(255, 248, 240), alpha=45)),
    ],
    'halo_eye': [   # 58: copper-gold center pop, soft brown edges
        ('blush', dict(style='cheeks', color=(240, 140, 120), alpha=35)),
        ('shadow', S(lid=((235, 175, 95), 60), crease=((160, 100, 60), 45),
                     outer=((140, 85, 50), 50), inner=((255, 240, 215), 40),
                     shimmer=((255, 225, 160), 50))),
        ('liner', dict(style='soft', color=(55, 40, 35), alpha=180)),
        ('lashes', dict(strength=0.75, style='wispy')),
        ('brow', dict(color=(70, 50, 42), alpha=95, width=0.058, density=0.55)),
        ('lip', dict(style='satin', color=(185, 125, 120), alpha=100)),
        ('highlight', dict(style='satin', color=(255, 240, 215), alpha=50)),
    ],
    'editorial_violet': [   # 10/67: violet-magenta graphic eye, quiet cheek, muted lip
        ('contour', dict(style='cool', alpha=25, areas=['cheek'])),
        ('blush', dict(style='cheeks', color=(205, 130, 160), alpha=25)),
        ('shadow', S(lid=((170, 70, 160), 65), crease=((130, 50, 120), 55),
                     outer=((95, 35, 85), 50), inner=((240, 225, 250), 35),
                     lower=((150, 60, 140), 40))),
        ('liner', dict(style='graphic', alpha=225)),
        ('lashes', dict(strength=0.6, style='wispy')),
        ('brow', dict(color=(50, 40, 45), alpha=95, width=0.055, density=0.55)),
        ('lip', dict(style='velvet', color=(130, 70, 90), alpha=120)),
        ('highlight', dict(style='pearl', color=(250, 245, 255), alpha=38)),
    ],
    'soft_bridal': [   # 51/53: rose shimmer, doll lash, rose-red satin lip
        ('blush', dict(style='cheeks', color=(245, 145, 150), alpha=42)),
        ('aegyo', dict(alpha=10)),
        ('shadow', S(lid=((240, 180, 185), 55), crease=((210, 140, 150), 42),
                     outer=((185, 110, 125), 35), inner=((255, 245, 248), 50),
                     shimmer=((255, 250, 252), 40))),
        ('liner', dict(style='wing', alpha=215)),
        ('lashes', dict(strength=1.0, style='doll')),
        ('lashes', dict(strength=0.3, style='wispy', lower=True)),
        ('brow', dict(color=(65, 48, 42), alpha=95, width=0.058, density=0.55)),
        ('lip', dict(style='satin', color=(200, 60, 80), alpha=135,
                     liner_color=(160, 40, 60))),
        ('highlight', dict(style='pearl', color=(255, 248, 248), alpha=55)),
    ],
    'tribal_earth': [   # 55: bronze-brown eye, strong straight brow, brown-nude matte
        ('contour', dict(style='warm', alpha=45)),
        ('blush', dict(style='sculpted', color=(200, 125, 95), alpha=35)),
        ('shadow', S(lid=((190, 140, 95), 50), crease=((150, 105, 70), 48),
                     outer=((120, 80, 55), 42), inner=((240, 220, 190), 30))),
        ('liner', dict(style='soft', color=(45, 32, 28), alpha=190)),
        ('lashes', dict(strength=0.65, style='wispy')),
        ('brow', dict(color=(45, 32, 28), alpha=125, width=0.075, density=0.8)),
        ('lip', dict(style='matte', color=(140, 90, 75), alpha=135)),
        ('highlight', dict(style='satin', color=(245, 230, 205), alpha=40)),
    ],
    'clean_girl': [
