...
# ── the LOOKS table — 12 retuned + 20 new ──────────────────────────────────
...
LOOKS = {
    'doll_pink': [
        ...
        ('liner', dict(style='wing', color=(30, 14, 20), alpha=210)),
        ('brow', dict(color=(75, 45, 40), alpha=95, width=0.065)),
        ('lashes', dict(style='doll', strength=1.0)),
        ('lashes', dict(style='wispy', strength=0.5, lower=True)),
    ...
    'egirl': [
        ...
        ('liner', dict(style='siren', color=(28, 14, 18), alpha=220)),
        ('aegyo', dict(alpha=22)),
        ('lashes', dict(style='doll', strength=0.85)),
    ...
    'glam_contour': [
        ...
        ('liner', dict(style='wing', color=(35, 18, 16), alpha=205)),
        ('lashes', dict(style='doll', strength=1.0)),
    ...
    'coquette': [
        ...
        ('lashes', dict(style='doll', strength=0.65)),
        ('lashes', dict(style='wispy', strength=0.4, lower=True)),
    ...
    'goth': [
        ...
        ('liner', dict(style='graphic', color=(25, 12, 20), alpha=230)),
        ('lashes', dict(style='stage', strength=1.0)),
    ...
    'peach': [
        ...
        ('lashes', dict(style='wispy', strength=0.6)),
    ...
    'cold_beauty': [
        ...
        ('liner', dict(style='soft', alpha=155)),
        ('highlight', dict(style='pearl', color=(240, 235, 245), alpha=45)),
        ('lashes', dict(style='wispy', strength=0.5)),
    ],
    'sunset': [
        ...
        ('liner', dict(style='wing', color=(35, 18, 12), alpha=210)),
        ('lashes', dict(style='doll', strength=0.9)),
    ...
    'angel': [
        ...
        ('liner', dict(style='soft', alpha=150)),
        ('brow', dict(color=(70, 50, 50), alpha=80, width=0.060)),
        ('lashes', dict(style='doll', strength=0.55)),
        ('lashes', dict(style='wispy', strength=0.35, lower=True)),
    ...
    'baddie': [
        ...
        ('liner', dict(style='siren', color=(30, 15, 14), alpha=220)),
        ('lashes', dict(style='cat', strength=0.95)),
    ...
    'cyber_chrome': [
        ...
        ('lashes', dict(style='stage', strength=0.9)),
    ...
    'hearts_freckles': [
        ...
        ('liner', dict(style='wing', alpha=190)),
        ('aegyo', dict(alpha=26)),
        ('lashes', dict(style='doll', strength=0.75)),
        ('lashes', dict(style='wispy', strength=0.4, lower=True)),
    ...
    'clean_girl': [
        ...
        ('liner', dict(style='tightline', alpha=140)),
        ('lashes', dict(style='wispy', strength=0.45)),
    ...
    'soft_glam_nude': [
        ...
        ('liner', dict(style='wing', alpha=190)),
        ('lashes', dict(style='wispy', strength=0.8)),
    ...
    'bronze_sculpt': [
        ...
        ('liner', dict(style='wing', alpha=195)),
        ('lashes', dict(style='cat', strength=0.85)),
    ...
    'latte': [
        ...
        ('liner', dict(style='soft', alpha=160)),
        ('lashes', dict(style='wispy', strength=0.7)),
    ...
    'rosewood': [
        ...
        ('lashes', dict(style='wispy', strength=0.75)),
    ...
    'berry_bitten': [
        ...
        ('lashes', dict(style='wispy', strength=0.55)),
    ...
    'cherry_gloss': [
        ...
        ('lashes', dict(style='cat', strength=0.9)),
    ...
    'terracotta_smoke': [
        ...
        ('liner', dict(style='smudged', alpha=190)),
        ('lashes', dict(style='cat', strength=0.9)),
    ...
    'emerald_smoke': [
        ...
        ('liner', dict(style='wing', color=(20, 80, 60), alpha=200)),
        ('lashes', dict(style='wispy', strength=0.8)),
    ...
    'sapphire_night': [
        ...
        ('liner', dict(style='wing', color=(25, 60, 100), alpha=210)),
        ('lashes', dict(style='cat', strength=0.95)),
    ...
    'plum_velvet': [
        ...
        ('liner', dict(style='wing', color=(50, 25, 45), alpha=205)),
        ('lashes', dict(style='wispy', strength=0.85)),
    ...
    'mocha_siren': [
        ...
        ('liner', dict(style='siren', color=(45, 28, 20), alpha=215)),
        ('lashes', dict(style='cat', strength=1.0)),
    ...
    'ballet_pink': [
        ...
        ('liner', dict(style='soft', alpha=150)),
        ('lashes', dict(style='doll', strength=0.85)),
        ('lashes', dict(style='wispy', strength=0.45, lower=True)),
    ...
    'sunkissed_freckles': [
        ...
        ('liner', dict(style='tightline', alpha=145)),
        ('lashes', dict(style='wispy', strength=0.6)),
    ...
    'grunge_smoke': [
        ...
        ('liner', dict(style='smudged', color=(35, 25, 25), alpha=190)),
        ('lashes', dict(style='wispy', strength=0.7)),
    ...
    'midnight_goth': [
        ...
        ('liner', dict(style='graphic', color=(20, 12, 20), alpha=235)),
        ('lashes', dict(style='stage', strength=1.0)),
    ...
    'opal_fantasy': [
        ...
        ('liner', dict(style='soft', color=(120, 100, 150), alpha=170)),
        ('lashes', dict(style='wispy', strength=0.7)),
