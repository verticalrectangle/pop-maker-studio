...
LOOKS = {
    ...
    "doll_pink": [
        ...
        ("liner", dict(style="doe", alpha=210)),
    ...
    "egirl": [
        ...
        ("liner", dict(style="wing", alpha=225)),
        ("lashes", dict(strength=0.95, style="spiky")),
        ("lashes", dict(strength=0.4, style="wispy", lower=True)),
        ("aegyo", dict(alpha=12)),
    ...
    "goth": [
        ...
        ("shadow", S(lid=((72, 42, 68), 100), crease=((52, 26, 47), 90),
                     ...
                     lower=((48, 24, 42), 65))),
        ("liner", dict(style="wrap", alpha=245)),
    ...
    "sunset": [
        ...
        ("liner", dict(style="dramatic", alpha=230)),
    ...
    "hearts_freckles": [
        ...
        ("liner", dict(style="puppy", alpha=210)),
        ("lashes", dict(strength=0.75, style="doll")),
        ("aegyo", dict(alpha=14)),
    ...
    "korean_dewy": [
        ("blush", dict(style="cheeks", color=(255, 150, 140), alpha=42)),
        ("aegyo", dict(alpha=18)),
        ("shadow", S(lid=((227, 172, 162), 52), crease=((207, 147, 142), 42),
                     inner=((255, 245, 240), 46), shimmer=((255, 250, 245), 32))),
        ("liner", dict(style="tightline", color=(60, 40, 36), alpha=170)),
        ("lashes", dict(strength=0.6, style="wispy")),
        ("lip", dict(style="blurred", color=(232, 112, 102), alpha=115)),
        ("highlight", dict(style="glass", color=(255, 250, 248), alpha=60)),
    ],
    "chinese_classic": [
    ...
    "bollywood": [
        ...
        ("liner", dict(style="dramatic", alpha=235)),
        ("lashes", dict(strength=1.05, style="stage")),
    ...
    "pinup": [
        ...
        ("liner", dict(style="dramatic", alpha=240)),
    ...
    "arab_kohl": [
        ...
        ("shadow", S(lid=((217, 172, 122), 57), crease=((172, 122, 87), 57),
                     ...
                     lower=((60, 40, 40), 72))),
        ("liner", dict(style="kohl", alpha=240)),
        ("lashes", dict(strength=1.05, style="stage")),
        ("lashes", dict(strength=0.45, style="wispy", lower=True)),
    ...
    "siren_night": [
        ...
        ("liner", dict(style="wrap_wing", alpha=235)),
    ...
    "fox_eye": [
        ("contour", dict(style="warm", alpha=32, areas=["cheek", "temple"])),
        ("blush", dict(style="lifted", color=(225, 150, 130), alpha=32)),
        ("shadow", S(lid=((212, 167, 127), 58), crease=((182, 137, 97), 55),
                     outer=((152, 107, 72), 62), inner=((250, 240, 225), 40))),
        ("liner", dict(style="siren", alpha=235)),
        ("lashes", dict(strength=1.05, style="cat")),
        ("lip", dict(style="satin", color=(195, 140, 125), alpha=110)),
        ("highlight", dict(style="satin", color=(255, 245, 235), alpha=48)),
    ],
    "doe_eye": [
        ("blush", dict(style="apple", color=(250, 150, 155), alpha=46)),
        ("aegyo", dict(alpha=22)),
        ("shadow", S(lid=((242, 197, 177), 52), crease=((222, 162, 147), 42),
                     inner=((255, 250, 245), 58), lower=((255, 245, 240), 42))),
        ("liner", dict(style="doe", color=(50, 35, 32), alpha=165)),
        ("lashes", dict(strength=1.05, style="doll")),
        ("lashes", dict(strength=0.5, style="doll", lower=True)),
        ("lip", dict(style="gloss", color=(240, 140, 140), alpha=105)),
        ("highlight", dict(style="satin", color=(255, 248, 248), alpha=55)),
    ],
    "y2k_glow": [
    ...
    "nineties_brown": [
        ...
        ("liner", dict(style="smudged", color=(60, 40, 35), alpha=195)),
        ("lashes", dict(strength=0.65, style="wispy")),
    ...
    "cut_crease": [
        ...
        ("blush", dict(style="lifted", color=(225, 145, 125), alpha=35)),
        ("shadow", S(lid=((247, 227, 202), 62), crease=((150, 112, 92), 95),
                     outer=((120, 90, 75), 70), inner=((255, 245, 235), 50),
                     shimmer=((255, 250, 240), 42))),
        ("liner", dict(style="wing", alpha=232)),
        ("lashes", dict(strength=1.05, style="stage")),
        ("lip", dict(style="lined_gloss", color=(185, 135, 120), alpha=120,
                     liner_color=(140, 95, 85))),
        ("highlight", dict(style="satin", color=(255, 248, 240), alpha=50)),
    ],
    "halo_eye": [
    ...
    "editorial_violet": [
        ...
        ("shadow", S(lid=((172, 72, 162), 67), crease=((132, 52, 122), 57),
                     ...
                     lower=((152, 62, 142), 42))),
        ("liner", dict(style="floating", alpha=230)),
        ("lashes", dict(strength=0.65, style="wispy")),
    ...
    "tribal_earth": [
        ("contour", dict(style="warm", alpha=48)),
        ("blush", dict(style="lifted", color=(200, 125, 95), alpha=42)),
        ("shadow", S(lid=((192, 142, 97), 64), crease=((152, 107, 72), 60),
                     outer=((122, 82, 57), 54), inner=((240, 220, 190), 36))),
        ("liner", dict(style="soft", color=(45, 32, 28), alpha=215)),
        ("lashes", dict(strength=0.8, style="wispy")),
        ("lip", dict(style="matte", color=(140, 90, 75), alpha=155)),
        ("highlight", dict(style="satin", color=(245, 230, 205), alpha=45)),
    ],
}
