...
ML inference (WhisperX via faster-whisper, Demucs, vision describe) is already
...
The desktop app already runs WhisperX/Demucs/vision locally behind the
...
- WhisperX, Demucs, vision describe run as jobs against the session's tmpfs,
