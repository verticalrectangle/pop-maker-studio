...
// Ping-pong FBO pair
static GLuint g_fbo[2]     = {};
static GLuint g_fbo_tex[2] = {};
...
void fx_shader_shutdown() {
    ...
    glDeleteTextures(2, g_fbo_tex);
    g_prog_grade = g_prog_blur_h = g_prog_blur_v = 0;
    g_vao = g_vbo = 0;
    g_fbo[0]=g_fbo[1]=0; g_fbo_tex[0]=g_fbo_tex[1]=0;
    g_fbo_w = g_fbo_h = 0;
}
